...
INSERT INTO employee (full_name, position, email, id_department) VALUES 
...
INSERT INTO vulnerability (cve_id, description, id_status, id_asset, id_severity, id_source) VALUES 
('CVE-2026-0001', 'SQL-инъекция в панели входа', 1, 1, 4, 3),
('CVE-2026-0002', 'Устаревшая версия Nginx', 2, 2, 2, 1),
('CVE-2026-0003', 'Слабый пароль RDP', 1, 1, 3, 2),
('CVE-2026-0004', 'Открытый порт 445', 1, 3, 2, 1);

-- 8. Заполняем инциденты
