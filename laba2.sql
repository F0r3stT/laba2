...
SELECT DISTINCT v.id_vulnerability, v.cve_id
...
SELECT get_open_incidents_count() AS open_incidents;
...
SELECT get_avg_vulns_per_asset() AS avg_vulns_per_asset;
...
SELECT * FROM get_high_crit_employees();
